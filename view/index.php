 ...
 <body style="background-color: silver;">  
      <head>  
           ...
           <a>  <span style= "font-size: 20px; float: left; margin: 20px; color: red;"><?php echo "USER: ".$_SESSION['name']?></span>
           </a>                         
      ...
      <body>  
           ...
           <div class="container" style="width:700px;">  
                <h3 align="center">Burger Selection</h3><br />  
                <?php  
                ...
                <label for="Payment"><p style="color: blue "><strong>Select  Payment Type:</strong></p></label>
